  ...
  <div class="block full">
      <div class="block-title">
          <h2><strong>Coupon Master Orders</strong> </h2>
           ...
           <h1 class="pull-right">
                 <a class="btn btn-primary pull-right" style="margin-top: -8px;margin-bottom: 5px" href="{{ route('couponMasterOrders.create') }}">Add New</a>
          </h1>
                  ...
                  @foreach ($data as $key => $rating)
                    <tr>
                      ...
                      <td class="text-center">
                          {!! Form::open(['route' => ['couponMasterOrders.destroy', $rating->id], 'method' => 'delete']) !!}
                            <div class='btn-group'>
                                                           
                                <a href="{{ route('couponMasterOrders.edit', $rating->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
