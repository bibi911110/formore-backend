...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <!-- <img src="{{url('public/new/img/placeholders/backgrounds/login_full_bg.jpg')}}" alt="Login Full Background" class="full-bg animation-pulseSlow"> -->
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center" style="background-color:white !important;">
                <!-- <h1><i class="gi gi-flash"></i> <strong>ForMore</strong><br><small>Please <strong>Login</strong> </h1> -->
                    <img src="{{url('public/backend/images/logo.png')}}" style="width: 27%;">
                <hr>
            </div>
            <!-- END Login Title -->
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="text" id="login-email" name="email" class="form-control input-lg" placeholder="Email" value="{{ old('email') }}">
                                 @if ($errors->has('email'))
       ...
       <!--  <div id="modal-terms" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <script src="{{url('public/new/js/pages/login.js')}}"></script>
