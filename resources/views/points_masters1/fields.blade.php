...
<div class="form-group" id=''>
    ...
    <!-- {!! Form::text('levels_based_on_scenarios', null, ['class' => 'form-control']) !!} -->
      {!! Form::select('levels_based_on_scenarios', [''=>'Select Schema',"0" => '0','1' => '1',"2" => '2',"3" => '3',"4" => '4'], null, ['class' => 'form-control','id' => 'levels_based_on_scenarios']) !!}
</div>
<div class="form-group">
    {!! Form::label('levels_based_amount', 'Levels Based Amount:') !!}
    {!! Form::text('levels_based_amount', null, ['class' => 'form-control','onkeypress'=>"return isNumberKey(event)"]) !!}
</div>
</div>
...
<div class="col-md-3">
    <div class="form-group" id=''>
        ...
        <select class="form-control" name="segments_based_on_scenarios[]" >
            ...
            <option value="0" <?php if($sgp_data->segments_based_on_scenarios == 0){ echo "selected" ;} ?>>2</option>
...
<div class="row itemClass" id="item_1">
 ...
 -->
  <!-- <div class="col-md-3">
    ...
    {!! Form::select('user_id[]',$user_data->toArray(), null, ['class' => 'form-control select-chosen','id' =>'','multiple','data-placeholder'=>'Select User']) !!}
</div> -->
<!-- </div> -->
    <div class="col-md-3">
          <div class="form-group">
