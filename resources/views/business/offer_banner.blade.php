                ...
                <div class="block-title">
                    ...
                    {!! Form::open(['route' => 'post_give_voucher', 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="modal-dialog modal-lg">
                              ...
                              <div class="modal-content">
                                ...
                                <center>  
                                 ...
                                 <?php $app_info = \App\Models\App_screen_information::where('screen_name','Offer details info')->where('language_id','1')->first(); ?>
                         ...
                         <?php $app_info = \App\Models\App_screen_information::where('screen_name','Offer info')->where('language_id','1')->first(); ?>
                                <div class="form-group">
                                    {!! Form::label('info', 'Info:') !!}
                                    <p>{!! $app_info->content !!}</p>
                                </div>
