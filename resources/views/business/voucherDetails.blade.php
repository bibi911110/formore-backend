                ...
                <div class="block-title">
                    ...
                    {!! Form::open(['route' => 'findMemberDetails', 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <!-- Widget -->
                                <a href="{{url('appointments_view_id_wise').'/'.$userDetails->id}}" class="widget widget-hover-effect1" style="background-color:#e67e22;color: white;;">
                                    <div class="widget-simple">
                                       <div class="widget-icon pull-left themed-background-autumn animation-fadeIn">
                                            <i class="fa fa-file-text"></i>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-12">
                                <?php $app_info = \App\Models\App_screen_information::where('screen_name','Option info')->where('language_id','1')->first(); ?>
