              ...
              <tbody>
                <?php $i=1; ?>
                  @foreach ($book_slot as $key => $slot)
                    <?php $appointmentCount = \App\Models\Booking_add_cart_time_order::where('slot_id',$slot->id)->where('business_id',$slot->business_id)->whereDate('date', \Carbon\Carbon::today())->count();  ?>
                    <tr>
