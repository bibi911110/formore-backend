       ...
       /* $categories = $this->categoryRepository->all(
        ...
        foreach ($categories as  $value) {
            if($i == 0)
            {
                ...
                $new[] = array('id' => $value['id'],"name" =>$value['name'],"icon" => $value['icon'],'status' => $value['status'],"created_at" => $value['created_at'],"updated_at" => $value['updated_at'],"deleted_at" => $value['deleted_at']);      
            }
            else
            {
                $new[] = array('id' => $value['id'],"name" =>$value['name'],"icon" => $value['icon'],'status' => $value['status'],"created_at" => $value['created_at'],"updated_at" => $value['updated_at'],"deleted_at" => $value['deleted_at']);
